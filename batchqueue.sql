...
SELECT 
    *,
    ...
    DENSE_RANK() OVER(
        ...
        NTILE(20) OVER(PARTITION BY assigned_study_site, baseline_mental_health, imd_quintile, baseline_dm, baseline_bp ORDER BY NEWID())
...
CREATE CLUSTERED INDEX IX_Universal_Batch ON Production_Batch_Queue(universal_batch_id, patient_id);
